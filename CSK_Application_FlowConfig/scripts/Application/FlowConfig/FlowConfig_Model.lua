...
local setFlowConfig_ModelHandle = require('Application/FlowConfig/FlowConfig_Controller')
setFlowConfig_ModelHandle(flowConfig_Model)

--Loading helper functions if needed
flowConfig_Model.helperFuncs = require('Application/FlowConfig/helper/funcs')
