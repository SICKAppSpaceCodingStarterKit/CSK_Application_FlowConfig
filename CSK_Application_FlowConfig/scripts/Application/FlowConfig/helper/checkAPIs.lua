...
local function loadAPIs()
  CSK_Application_FlowConfig = require 'API.CSK_Application_FlowConfig'
  ...
  for i = 1, #appList do
    ...
    elseif appList[i] == 'CSK_Module_SensorAppOverview' then
      CSK_SensorAppOverview = require 'API.CSK_SensorAppOverview'
    elseif appList[i] == 'SICK_WelcomeApp' then
      SICK_WelcomeApp = require 'API.SICK_WelcomeApp'
    end
  end
end
