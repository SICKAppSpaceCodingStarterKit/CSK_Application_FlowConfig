...
export function changeStyle(theme) {
  ...
  if (theme == 'CSK_Style'){
    ...
    var nofullscreen = `.sjs-fullscreen-toggle>i["fa fa-compress"] { display: none; }`

    var customBackground =  `.CSK_Application_FlowConfig .myCustomBackground_CSK_Application_FlowConfig { background-color: #737F8522; }` // font-family: "Open Sans"; }`
    ...
    var customBackground =  `.CSK_Application_FlowConfig .myCustomBackground_CSK_Application_FlowConfig { background-color: #fff; }` // font-family: "sans-serif"; }`
